...
class Unpacking_BIts(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "unpackbits", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("unpackbits")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Unpacking_BIts")
...
def main(top_block_cls=Unpacking_BIts, options=None):
